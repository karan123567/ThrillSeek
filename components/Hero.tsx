...
import { ArrowRight, Compass, MapPin, ShieldCheck, Backpack } from "lucide-react";

export default function Hero() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden">
      {/* Background — full bleed, no mercy */}
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop"
      ...
      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-12 w-full">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 lg:gap-16">

          {/* LEFT — Minimal copy */}
          <div className="max-w-xl pb-8 lg:pb-16">
            {/* Badge */}
            <div className="animate-fade-in-up opacity-0 mb-6" style={{ animationDelay: "0.1s" }}>
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 text-white/80 text-xs font-medium">
                <span className="flex h-2 w-2 relative">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                </span>
            ...
            {/* Headline — the only text that matters */}
            <h1
              className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-tighter leading-[0.9] mb-6 animate-fade-in-up opacity-0 text-white"
            ...
            {/* Single CTA */}
              <div className="flex flex-wrap items-center gap-3">
                <a
                  href="#adventures"
                  className="group inline-flex items-center gap-3 bg-white text-[#0a0a0a] px-7 py-3.5 rounded-xl text-sm font-semibold hover:bg-neutral-200 transition-colors"
                >
                  Explore Adventures
                ...
                <a
                  href="#"
                  className="group inline-flex items-center gap-2 text-white/60 hover:text-white px-7 py-3.5 rounded-xl text-sm font-medium transition-colors"
                >
                  List Your Adventure
          ...
          {/* RIGHT — Quick-access modules */}
          <div className="hidden lg:flex flex-col gap-3 pb-16 animate-fade-in-up opacity-0" style={{ animationDelay: "0.5s" }}>
            {[
              { icon: Compass, label: "Find Guides", desc: "Verified locals" },
              { icon: MapPin, label: "Popular Trails", desc: "Curated routes" },
              { icon: ShieldCheck, label: "Safety Tips", desc: "Stay prepared" },
              { icon: Backpack, label: "Packing Lists", desc: "Gear essentials" },
            ].map((item, i) => (
              <a
                key={i}
                href="#"
                className="group flex items-center gap-4 w-56 px-5 py-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 hover:bg-gray-400 hover:border-white/20 transition-all duration-300"
              >
      ...
      {/* Bottom social proof — very subtle, one line */}
      <div className="absolute bottom-8 left-5 sm:left-6 lg:left-12 animate-fade-in-up opacity-0" style={{ animationDelay: "0.6s" }}>
        <div className="flex items-center gap-3">
          <div className="flex -space-x-2">
            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face" className="w-7 h-7 rounded-full border-2 border-[#0a0a0a] object-cover" alt="" />
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face" className="w-7 h-7 rounded-full border-2 border-[#0a0a0a] object-cover" alt="" />
            <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face" className="w-7 h-7 rounded-full border-2 border-[#0a0a0a] object-cover" alt="" />
            <div className="w-7 h-7 rounded-full border-2 border-[#0a0a0a] bg-brand-600 flex items-center justify-center text-[9px] font-bold text-white">+5K</div>
          </div>
          <p className="text-xs text-white/40">
            <span className="text-white/70 font-medium">50,000+</span> adventurers this year
          </p>
        </div>
      </div>
    </section>
